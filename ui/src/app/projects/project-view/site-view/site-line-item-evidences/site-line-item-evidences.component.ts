...
import { GetMilestoneEvidencesResponse, ProjectSiteLineItemEvidence as EvidenceRow } from 'src/app/projects/projects.interface';
...
@Component({
  selector: 'app-site-line-item-evidences',
  standalone: true,
  imports: [
  ...
  templateUrl: './site-line-item-evidences.component.html',
  styleUrl: './site-line-item-evidences.component.less'
})
export class SiteLineItemEvidencesComponent implements OnDestroy {
  ...
  protected readonly fetchPageHandler = computed<(limit: number, offset: number, filterSort: FilterSortConfiguration) => Observable<GetMilestoneEvidencesResponse>>(() => {
    return (limit: number, offset: number, filterSort: FilterSortConfiguration): Observable<any> => {
      ...
      return this.projectsService.getSiteLineItemsEvidences(this.projectId(), this.siteId(), { limit, offset }, filterSortToApply);
    };
  });
  protected readonly evidencesMetrics = computed(() => {
    return this.projectsService.getSiteLineItemsEvidencesMetrics(this.projectId(), this.siteId());
  });
